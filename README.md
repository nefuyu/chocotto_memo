...
このプロジェクトは、**AI駆動開発の自己研鑽**として始めた個人開発です。
業務ではAI駆動開発を試す機会がないため、個人プロジェクトを通じて実際に手を動かしてみることにしました。DartもFlutterも未経験の状態からスタートし、設計から実装まで一通りの流れをAIと一緒に進めています。
メリット・デメリットを含めてAI駆動開発をちゃんと理解すること、そして何か動くものを世に出すことが目標です。
